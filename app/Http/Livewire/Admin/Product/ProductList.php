...
class ProductList extends Component
{
    ...
    public $searchProductname,$searchProductdetails,$searchPrice,$searchofferprice, $searchStatus = -1, $perPage = 5;
    ...
    public function render()
    {
        ...
        if ($this->searchofferprice)
            $productQuery->Where('offer_price', 'like', '%' . $this->searchofferprice . '%');
        if ($this->searchProductdetails)
            $productQuery->Where('product_details', 'like', '%' . $this->searchProductdetails . '%');
    ...
    public function changeStatus(Product $product)
    {
        ...
        $this->showModal('success', 'Success', 'Product is changed successfully');
    }
}
