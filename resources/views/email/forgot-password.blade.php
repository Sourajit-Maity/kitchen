...
<center><a href="#">Reset Password</a></center>
<br>
<b>If you did not request a password reset, no further action is required.</b>
{{-- <br>
<a class="btn btn-primary" href="{{ route('reset-password', Crypt::encrypt($user->id)) }}">Click</a> --}}
</td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            <tr><td>&nbsp;</td></tr>
            ...
            <tr bgcolor="#f42a6c">
                <td style="font-weight:bold;font-size:12px;padding-left:12px">    
                    <p style="background:#f42a6c;font-size:12px;text-align:center;padding:10px;border-top:1px solid #000;color:#FFFFFF;">Please do not reply to this email, as this is an unmonitored email address. You can contact to <span style="color: #FFFFFF;">{{env('MAIL_FROM_ADDRESS')}}</span> for any related query.<br />&copy; {{ env('APP_NAME') }} @php
                        echo date('Y');
                    @endphp</p>
                </td>
            </tr>
