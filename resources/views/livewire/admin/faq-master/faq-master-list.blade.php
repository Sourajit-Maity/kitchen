        ...
        <tr role="row">
            <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 22%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">Question <i
                    class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" wire:click="sortBy('faq_question')"></i>
            </th>
            <!-- <th tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 22%;"
                aria-sort="ascending" aria-label="Agent: activate to sort column descending">Answer <i
                    class="fa fa-fw fa-sort pull-right" style="cursor: pointer;" wire:click="sortBy('faq_answer')"></i>
            </th> -->
    ...
    <x-slot name="tbody">
        @forelse($faqMasters as $faqMaster)
            <tr role="row" class="odd"> 
                <td class="sorting_1" tabindex="0">{{ $faqMaster->faq_question  }}</td>
                <!-- <td class="sorting_1" tabindex="0">{{ Str::limit($faqMaster->faq_answer , 25) }}</td> -->
